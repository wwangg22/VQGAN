...
class VQGAN(nn.Module):
    def __init__(self,
                 n_embeddings, embedding_dim, out_ch=3, ch_mult=(1,2,4,8), num_res_blocks=2, 
                 ch=128, attn_resolutions = [16], dropout = 0.0, resamp_with_conv=True,
        ...
        self.encoder = Encoder(
            ...
            in_channels=in_channels, resolution=resolution, z_channels=embedding_dim
        )
    ...
    def forward(self, x, verbose=False, gen_update=True):
        ...
        z_q, embedding_loss, perplexity, _, _ = self.vector_quantization(z_e)
